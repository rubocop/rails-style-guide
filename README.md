...
* [bullet](https://github.com/flyerhzm/bullet) - The Bullet gem is designed to
  ...
  counter cache.
* [cancancan](https://github.com/CanCanCommunity/cancancan) - CanCanCan is an
  authorization gem that lets you restrict users access to resources. All permissions 
  are defined in a single file (ability.rb) and convenient methods for checking and
  ensuring permissions are available throughout the application.
...
* [devise](https://github.com/plataformatec/devise) - Devise is full-featured
  ...
  to use devise to roll your own custom authentication solution.
